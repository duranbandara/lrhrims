...
<div class="col-md-7">
    <div class="card shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h4 class="h5 m-0 font-weight-bold text-primary">Edit Supplier</h4>
        ...
        <div class="card-body">
            ...
            <?= form_open('supplier/edit/' . $supplier['id_supplier']) ?>
            <div class="form-group row">
                <label class="col-md-3 col-form-label text-md-right">Supplier Name <span class="text-danger">*</span></label>
                <div class="col-md-8"><input type="text" name="des_supplier" class="form-control" value="<?= old('des_supplier', $supplier['des_supplier']) ?>"></div>
            </div>
            <div class="form-group row">
                <label class="col-md-3 col-form-label text-md-right">Phone Number <span class="text-danger">*</span></label>
                <div class="col-md-8"><input type="text" name="no_telp" class="form-control" value="<?= old('no_telp', $supplier['no_telp']) ?>"></div>
            </div>
            <div class="form-group row">
                <label class="col-md-3 col-form-label text-md-right">Address <span class="text-danger">*</span></label>
                <div class="col-md-8"><textarea name="address" class="form-control" rows="3"><?= old('address', $supplier['address']) ?></textarea></div>
            </div>
            <div class="form-group row">
