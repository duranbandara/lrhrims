<div class="row justify-content-center"><div class="col-md-6">
    <div class="card shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between">
            <h4 class="h5 m-0 font-weight-bold text-primary">Edit Unit</h4>
        ...
        <div class="card-body">
            ...
            <?= form_open('unit/edit/' . $unit['id_unit']) ?>
            <div class="form-group row">
                <label class="col-md-4 col-form-label text-md-right">Unit Name <span class="text-danger">*</span></label>
                <div class="col-md-7"><input type="text" name="des_unit" class="form-control" value="<?= old('des_unit', $unit['des_unit']) ?>"></div>
            </div>
