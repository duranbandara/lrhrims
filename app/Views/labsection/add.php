<div class="row justify-content-center"><div class="col-md-6">
    <div class="card shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between">
            <h4 class="h5 m-0 font-weight-bold text-primary">Add Lab Section</h4>
        ...
        <div class="card-body">
            ...
            <?= form_open('labsection/add') ?>
            <div class="form-group row">
                <label class="col-md-4 col-form-label text-md-right">Section Name <span class="text-danger">*</span></label>
                <div class="col-md-7"><input type="text" name="section_name" class="form-control" value="<?= old('section_name') ?>" maxlength="100"></div>
            </div>
